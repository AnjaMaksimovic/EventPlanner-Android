...
import com.example.eventplanner.databinding.ActivityPackageEditingBinding;
import com.example.eventplanner.databinding.ActivityProductCreatingBinding;
import com.example.eventplanner.model.Product;

import java.util.ArrayList;

public class PackageEditingActivity extends AppCompatActivity {

    private ActivityPackageEditingBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPackageEditingBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        prepareProductList();

        ImageButton backBtn = binding.packageEditFormInclude.btnBack;
        backBtn.setOnClickListener(v -> {
            finish();
        });

        Button productsPopupBtn = binding.packageEditFormInclude.openProductsListPopup;
